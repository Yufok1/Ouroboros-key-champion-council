...
Local-first AI orchestration platform. Run multi-model workflows, semantic memory, diagnostics, and community collaboration from one system.
...
- **Decentralized Community** — Nostr-based marketplace, live chat, encrypted DMs, P2P voice rooms, zaps.
