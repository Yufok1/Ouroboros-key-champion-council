/* Vendored from Three.js r160 examples/jsm/postprocessing with dependencies inlined. */
(function (THREE) {
    if (!THREE) throw new Error('THREE namespace is required for EffectComposer.js');
