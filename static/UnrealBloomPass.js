/* Vendored from Three.js r160 examples/jsm/postprocessing/UnrealBloomPass.js with shader dependencies inlined. */
(function (THREE) {
    if (!THREE) throw new Error('THREE namespace is required for UnrealBloomPass.js');
