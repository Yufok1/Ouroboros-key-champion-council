# Cursor Operator Contract Clipboard - 2026-04-30

Source: operator clipboard captured on request for Cursor fast-track onboarding.

This is the portable operating contract Cursor should apply before audit/eval work.
